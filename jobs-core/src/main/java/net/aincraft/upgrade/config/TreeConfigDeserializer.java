...
import net.aincraft.upgrade.tree.AbilityMeta;
import net.aincraft.upgrade.tree.AbilityMeta.BoostConfig;
import net.aincraft.upgrade.tree.AbilityMeta.EffectConfig;
import net.aincraft.upgrade.tree.AbilityMeta.RuleConfig;
import net.aincraft.upgrade.tree.Archetype;
import net.aincraft.upgrade.tree.IconConfig;
import net.aincraft.upgrade.tree.LayoutItem;
import net.aincraft.upgrade.tree.LayoutItemType;
import net.aincraft.upgrade.tree.TreeConfig;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

/**
 * Custom Gson deserializer for TreeConfig.
 * Handles the polymorphic meta field in LayoutItem.
 */
public final class TreeConfigDeserializer implements JsonDeserializer<TreeConfig> {

  @Override
  public TreeConfig deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) {
    ...
    return new TreeConfig(treeId, displayName, description, job, skillPointsPerLevel, rootId, paths, archetypes, layout, perkPolicies);
  }
  ...
  private LayoutItem deserializeLayoutItem(JsonObject itemObj, JsonDeserializationContext context) {
    ...
    return new LayoutItem(id, type, coordinates, (net.aincraft.upgrade.tree.LayoutItemMeta) metaObj, archetypeRef, family);
  }
