...
/**
 * Parses TreeConfig into UpgradeTree instances.
 * Supports the JSON format with archetypes and explicit positioning.
 */
public final class TreeConfigParser {
  ...
  /**
   * Parse a tree config into an UpgradeTree.
   *
   * @param config the parsed JSON configuration
   * @return a fully constructed UpgradeTree
   */
  public UpgradeTree parse(TreeConfig config) {
