...
import net.aincraft.commands.top.PageConsumer;
...
final class TopCommand implements JobsCommand {
  ...
  static final class JobsTopPageProvider {
    ...
    @Inject
    private JobsTopPageProvider(JobService jobService) {
      this.jobService = jobService;
    }
    ...
    PageConsumer.Page<List<JobProgression>> getPage(Key jobKey, int pageNumber,
      ...
      return new Page<>(slice, clampedPage, pageSize);
    }
  }
}
