 ...
 * Tracking starts automatically on the first player-inflicted damage and only updates
 * already-tracked entities for non-player damage.
 */
final class MobDamageTrackerController implements Listener {
  ...
  /**
   * On MONITOR priority, attributes {@code EntityDamageByEntityEvent} damage to an entity:
   * projectile damage is attributed to its shooter, and tameable damage to its owning player.
   * Non-player damage only affects entities that are already being tracked.
   */
