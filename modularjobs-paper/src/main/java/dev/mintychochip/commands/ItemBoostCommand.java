...
public final class ItemBoostCommand implements JobsCommand {
                    ...
                    Commands.argument("material", StringArgumentType.word())
                        .then(
                            Commands.argument("boostKey", ArgumentTypes.key())
                                ...
                                .then(
                                    Commands.argument("slotSet", StringArgumentType.greedyString())
                                        .executes(
                                            context -> {
                                              Player target =
                                                  context
                                              ...
                                              return giveItemBoost(
                                                  ...
                                                  context.getArgument("material", String.class),
                                                  context
                                                      .getArgument("boostKey", Key.class)
                                                      .asString(),
  ...
  private int giveItemBoost(
    ...
    item.lore(
        java.util.List.of(
            Component.text("Boost: " + boostKeyStr), Component.text("Slots: " + slotSetSpec)));
    ...
    Messages.send(
        sender,
        "<accent>Gave <secondary>"
            + target.getName()
            + "<accent> an item with boost <primary>"
            + boostKeyStr);
