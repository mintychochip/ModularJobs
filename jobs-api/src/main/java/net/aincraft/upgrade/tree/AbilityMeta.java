...
/**
 * Metadata for ability nodes in a skill tree.
 ...
 * @param maxedPrerequisites   list of node IDs that must ALL be at max level before this can be unlocked
 ...
 * @param nodeTexture       optional texture name for custom node rendering (e.g., "blue", "warrior")
 */
