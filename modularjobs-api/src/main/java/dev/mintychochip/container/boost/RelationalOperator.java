 ...
 *
 * <p>Each constant compares its operands with {@link BigDecimal#compareTo(BigDecimal)}, which
 * ignores scale, so values of equal magnitude (e.g. {@code 1} and {@code 1.00}) are considered
 * equal.
 */
