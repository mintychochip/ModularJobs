...
/**
 * Metadata for connector nodes in a Wynncraft-style skill tree. Connector nodes are visual path
 * segments that connect ability nodes. They have locked and unlocked states with different icons.
 *
...
public record ConnectorMeta(@NotNull List<String> links, @NotNull ConnectorShapes shapes)
   ...
   */
  public record ConnectorShapes(@NotNull IconConfig locked, @NotNull IconConfig unlocked) {}
}
