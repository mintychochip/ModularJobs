 ...
 *
 * <p>Each rule is independent: when {@code maxJobs} is positive, joining beyond the limit
 * is rejected; when the player lacks {@code jobs.join.<job>} permission, joining is rejected;
 * when world join restriction is enabled, a job cannot be joined while in a world that
 * pays nothing (i.e. listed in the payout disabled-worlds set).</p>
 *
 * <p>Outcome of a membership check.</p>
 */
