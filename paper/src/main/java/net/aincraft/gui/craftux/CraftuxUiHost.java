package net.aincraft.gui.craftux;
 ...
 *
 * <p>Owns the shared {@link InventoryRuntime} and Paper click bridge. Individual
 * GUIs build {@link dev.craftux.api.inventory.InventoryView}s and open them via
 * {@link #inventory()}; host actions are registered through {@link #actions()}.
 */
