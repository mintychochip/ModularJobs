...
/**
 * JDBC {@link Connection} wrapper that ignores {@code close()} so try-with-resources in
 * repositories can share one connection across operations (e.g. unit tests). Call {@link
 * #shutdown()} to actually close the delegate.
 */
@Internal
