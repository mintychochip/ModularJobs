...
/**
 * Implementation of PreferencesService that stores player preferences. Uses in-memory cache with
...
public class PreferencesServiceImpl implements PreferencesService {
  ...
  public void setEntriesPerPage(@NotNull UUID playerId, int entries) {
    ...
    PlayerPreferences prefs =
        preferencesCache.computeIfAbsent(playerId, k -> new PlayerPreferences());
