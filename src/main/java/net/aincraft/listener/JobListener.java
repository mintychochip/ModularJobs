...
public class JobListener implements Listener {
  ...
  static {
    RegistryContainer.registryContainer().editRegistry(RegistryKeys.JOBS, registry -> {
      ...
      payables.add(PayableTypes.EXPERIENCE.create(PayableAmount.create(BigDecimal.TWO)));
  ...
  private void onBlockPlace(final BlockPlaceEvent event) {
    ...
    if (Checks.Player.NOT_PAY_IN_CREATIVE.or(Checks.Player.NOT_PAY_WHILE_RIDING).test(player)) {
      return;
    }
