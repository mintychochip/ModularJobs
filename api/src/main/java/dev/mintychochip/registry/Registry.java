 ...
 *
 * <p>Registry identity is established by the {@link RegistryKey} used to look the registry up from
 * a {@link RegistryContainer}; a registry holds at most one object per key and registration of an
 * already-present key replaces the prior entry.
 */
public interface Registry<T extends Keyed> extends RegistryView<T> {
   ...
   *
   * <p>Registering an object whose key is already present replaces the existing entry.
   *
