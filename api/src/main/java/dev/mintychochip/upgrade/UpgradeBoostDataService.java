...
public interface UpgradeBoostDataService {
     ...
     * When a v2 skill tree state and matching {@link SkillTree} exist, sources are
     * derived from the active effects of each owned node. Otherwise the legacy
     * UpgradeTree path is used.
