...
/**
 * Metadata for ability nodes in a Wynncraft-style skill tree. Ability nodes are playable upgrades
 * that grant effects.
 *
...
public record AbilityMeta(
  ...
  public record RuleConfig(int priority, @NotNull Object conditions, @NotNull BoostConfig boost) {}

  /** Boost configuration for ruled_boost effects. */
  public record BoostConfig(@NotNull String type, @NotNull Double amount) {}
   ...
   */
  public record AbilityIcons(@NotNull IconConfig locked, @NotNull IconConfig unlocked) {}
}
