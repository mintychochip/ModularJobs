 ...
 *
 * <p>This utility class is not instantiable. The constants reference the registry entries keyed
 * under the {@code modularjobs} namespace; accessing them requires the payable-type registry to
 * have been populated at runtime.
 */
