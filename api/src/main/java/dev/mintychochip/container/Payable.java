 ...
 *
 * <p>This record is the canonical description of a reward and renders itself as an Adventure {@link
 * ComponentLike} through its {@link PayableType}.
 *
...
public record Payable(PayableType type, PayableAmount amount) implements ComponentLike {
  ...
  /**
   * Renders this payable as a text component, rounding the amount to two decimal places.
   *
