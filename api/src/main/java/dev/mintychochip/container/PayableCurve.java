 ...
 *
 * <p>Implementations evaluate the curve against the supplied variable map, for
 * example to scale a reward with a player's level derived from the
 * {@code progression}.</p>
 */
public interface PayableCurve {
   ...
   *
   * @param variables named inputs to the curve, for example the current
   *     progression level
