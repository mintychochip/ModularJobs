 ...
 *
 * <p>Implementations decide how deposit failures are surfaced; callers must not assume a return
 * value of {@code false} is atomic or recoverable.
 */
public interface EconomyProvider {

  /**
   * Returns whether the underlying economy is available and able to receive deposits at this time.
   *
   * @return {@code true} if currency deposits are supported and currently possible, {@code false}
   *     otherwise
   */
